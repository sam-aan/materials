...
class Detali:
    ...
    def tp(self):
        ...
        if self.material == 'Al':  # алюминий
            L = {'250': 30, '400': 68, '630': 68, '800': 83, '1000': 110, '1250': 140, '1600': 185, '2000': 226, '2500': 226, '2600': 226, '3200': 364,
            ...
            L = {'630': 68, '800': 68, '1000': 83, '1250': 110, '1600': 140, '2000': 185, '2500': 185, '3200': 235,
    ...
    def print_rezult(self):
        ...
        if self.naimenovanie in ['Крышка', 'Сухарь', 'Крышка средняя', 'Уголок_25х25х3', 'Крышка с выступом крашенная',
            ...
            nominalus = {800: 630, 1000: 800, 1250: 1000, 1600: 1250, 2000: 1600, 2500: 1600}
            nominal = nominalus[self.nominal]
        else:
