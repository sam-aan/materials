        ...
        def tipiz(os, calc, nominal):
            ...
            if self.tip == []:
                ...
                if int(self.L) in [3000]:
                    ...
                    svar_det = [['Ш-СД33', 1, ['s1_01', 1, L], ['stp09v', 3, 0],
                                 [float(L - A * 3 - calc['расстояние от оси до шины'] - 20 + 98), B, C]],
                                ['Ш-СД34', 1, ['s2_01', 1, L], ['stp09v', 3, 0],
                                 [float(L - A * 3 - calc['расстояние от оси до шины'] - 20 - 46), B, C]],
                                ['Ш-СД34', 1, ['s2_01', 1, L], ['stp09v', 3, 0],
